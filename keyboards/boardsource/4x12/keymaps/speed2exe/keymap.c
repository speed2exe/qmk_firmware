...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MAIN] = LAYOUT_ortho_4x12(
        ...
        KC_GESC,       LSFT_T(KC_S), LALT_T(KC_H), LGUI_T(KC_N), LCTL_T(KC_T),          KC_COMM,  KC_DOT,  RCTL_T(KC_A),          RGUI_T(KC_E), RALT_T(KC_O), RSFT_T(KC_I), KC_QUOT,
    ...
    [_EXTENDED] = LAYOUT_ortho_4x12(
        KC_TAB,    KC_EXLM,      KC_AT,        KC_HASH,      KC_DLR,             KC_PERC,  KC_CIRC,    KC_AMPR,            KC_ASTR,      KC_PLUS,    KC_UNDS,      KC_BSPC,
        TO(_MAIN), LSFT_T(KC_1), LALT_T(KC_2), LGUI_T(KC_3), LCTL_T(KC_4),       KC_5,     KC_6,       RCTL_T(KC_7),       RGUI_T(KC_8), RALT(KC_9), RSFT_T(KC_0), KC_GRV,
    ...
    [_NAV] = LAYOUT_ortho_4x12(
        ...
        TO(_MAIN),     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, KC_DEL,
    ...
    [_FN] = LAYOUT_ortho_4x12(
        XXXXXXX,       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, KC_BRIU, KC_BRID, KC_VOLU, KC_VOLD,  KC_MUTE,
        TO(_MAIN),     KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,    KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,   XXXXXXX,
